...
let UsersController = class UsersController {
    ...
    async updateUserBalance(userId, body) {
...
__decorate([
    (0, common_1.Get)(':userId/deposits'),
    __param(0, (0, common_1.Param)('userId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "getUserDeposits", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "getUserWithdrawals", null);
